...
tossbutton.addEventListener("click",(e)=>{
    ...
    function wiggleToss()
    {
        if(!tossbutton.disabled)
        {
            ...
            let tossHeading=document.querySelector("#instruction");
           
            tossHeading.style.animation="seek 0.3s normal 0s 1 none";
            console.log("hiiijijj");
            // instruction.style.animation="none";
            setTimeout(()=>{
                tossHeading.style.animation="";
            },200);
